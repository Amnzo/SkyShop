...
class AddressForm(forms.ModelForm):
    class Meta:
        model = Address
        fields = ['locality', 'city','phone_number']
        labels = {
            'locality': _('localité'),
            'city': _('Ville'),
            
        }
        widgets = {'locality':forms.TextInput(attrs={'label': 'Full Namee','class':'form-control', 'placeholder':'Popular Place like Restaurant, Religious Site, etc.'}),
                   'phone_number':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Télephone','label': 'Télephone','for': 'rania'}),
                   'city':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Ville','label': 'Full Name','for': 'rania'}),
